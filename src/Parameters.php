...
class Parameters
{
     ...
     * @param  Model|null  $model  Instancia del modelo si es un parámetro polimórfico.
     ...
     * @param  Model|null  $model  Instancia del modelo dueño del parámetro si aplica.
     ...
     *
     * @param  string  $key  El identificador único del parámetro.
     * @param  Model|null  $model  Instancia del modelo dueño si no es global.
     ...
     * @param  Model|null  $model  Instancia del modelo dueño del parámetro.
     ...
     *
     * @param  string  $key  El identificador único del parámetro.
     * @param  Model|null  $model  Instancia del modelo asociado.
